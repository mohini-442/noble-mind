        ...
        <>
            <div className="relative z-[2]" id="blog" >
                <div className="max-w-[1140px] px-3 xl:mx-auto mx-2 sm:mx-5 bg-newsletter py-12 md:h-[318px] rounded-[20px] flex items-center justify-center flex-col translate-y-[29%] ">
                    <h2 className=" font-Outfit font-light text-[32px] md:text-[48px] text-[#FDFDFF] text-center leading-[30px]">Subscribe to our <span className="font-semibold"> Newsletter!</span></h2>
                    ...
                    <form className="w-[314px] sm:w-[448px] p-2 sm:p-[10px_10px_10px_24px] bg-[#FFFFFF0D] border border-[#FDFDFF33] flex justify-between mt-4 md:mt-9 rounded-[6px]">
                        <input type="text" placeholder="Enter your email" className=" !w-[140px] placeholder:text-[#FDFDFF] text-[#FDFDFF] font-Outfit text-[14px] md:text-[16px] font-semibold bg-transparent border-none outline-none" />
                    ...
                    <div className="max-w-[1140px] mx-auto px-3 pt-28 md:pt-36 pb-16">
                        <div className="flex flex-row flex-wrap">
                            <div className="md:w-8/12 w-full">
                                ...
                                <p className="font-normal text-[16px] font-Exo 2 text-white pt-7">Follow Us</p>
                            ...
                            <div className="md:w-4/12 w-full pt-10 md:pt-0">
                                <div className="flex flex-row flex-wrap">
                                    <div className="w-1/2">
                                        <ul>
                                            <li className="font-semibold font-Outfit text-[16px] text-white">Maine</li>
                                            <li className="pt-3"><a href="#home" className="font-normal font-Outfit text-[16px] text-[#B7B7B4] hover:text-white duration-300 ">Home</a></li>
                                            <li className="pt-3"><a href="#aboutus" className="font-normal font-Outfit text-[16px] text-[#B7B7B4]  hover:text-white duration-300">About Us</a></li>
                                            <li className="pt-3"><a href="#aboutus" className="font-normal font-Outfit text-[16px] text-[#B7B7B4]  hover:text-white duration-300">services</a></li>
                                            <li className="pt-3"><a href="#whychooseus" className="font-normal font-Outfit text-[16px] text-[#B7B7B4] hover:text-white duration-300">Why Choose Us</a></li>
                                        </ul>
                                    </div>
                                    <div className="w-1/2">
                                        <ul>
                                            <li className="font-semibold font-Outfit text-[16px] text-white">Legal</li>
                                            <li className="pt-3"><a href="#contactus" className="font-normal font-Outfit text-[16px] text-[#B7B7B4] hover:text-white duration-300 text-nowrap">Term & Conduction</a></li>
                                            <li className="pt-3"><a href="#blog" className="font-normal font-Outfit text-[16px] text-[#B7B7B4]  hover:text-white duration-300">Privacy Policy</a></li>
                                            <li className="pt-3"><a href="#contactus" className="font-normal font-Outfit text-[16px] text-[#B7B7B4]  hover:text-white duration-300">Contact</a></li>
                                            <li className="pt-3"><a href="#home" className="font-normal font-Outfit text-[16px] text-[#B7B7B4] hover:text-white duration-300">(629) 555-0129</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
