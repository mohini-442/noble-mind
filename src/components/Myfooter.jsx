...
import { Facebook, Insta, Twitter, Linkedin, Footerlogo } from './Icons'
        ...
        <>
            <div className="relative z-[2]" id="blog" >
                ...
                <div className=" bg-footerbg bg-cover bg-no-repeat bg-center lg:bg-Size py-5">
                    <div className="max-w-[1140px] mx-auto px-3 lg:px-0 pt-28 md:pt-36 pb-16">
                        <div className="flex flex-row flex-wrap">
                            ...
                            <div className="lg:w-4/12 w-full pt-8 lg:pt-0">
                                <div className="flex flex-row flex-wrap">
                                    <div className="w-1/2">
                                        <ul>
