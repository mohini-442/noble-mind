                    ...
                    >
                        <div className="preloader flex flex-col justify-center items-center h-screen">
                            <div className="flex gap-3 items-center zoom-in-out-box cursor-pointer ">
                                <Image src={logo} alt="logo" height={38.43} width={221.86} className="" />
                                <div role="status">
                                    <svg aria-hidden="true" class="w-8 h-8 text-gray-200 animate-spin dark:text-[#fff] fill-[#000]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
